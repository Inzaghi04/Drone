...
#define LEDC_FREQ       8000   // 50Hz cho ESC
#define LEDC_RESOLUTION LEDC_TIMER_10_BIT
#define PWM_MIN_DUTY 3277  // map(1000us, 1000, 2000, 0, 16383)
#define PWM_MAX_DUTY 6554  // map(2000us, 1000, 2000, 0, 16383)


void setMotorSpeed(ledc_channel_t channel, float input) {
    if (input > 2000) input = 1999;
    uint32_t duty = (uint32_t)((input - 1000) * (PWM_MAX_DUTY - PWM_MIN_DUTY) / 1000 + PWM_MIN_DUTY);
